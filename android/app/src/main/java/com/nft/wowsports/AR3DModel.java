...
public class AR3DModel extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ar3_dmodel);
    ...
    public void loadModels(String urlformodel) {


        WeakReference<AR3DModel> weakActivity = new WeakReference<>(this);
        ModelRenderable.builder()
                .setSource(this, Uri.parse(urlformodel))
                .setIsFilamentGltf(true)
                .setAsyncLoadEnabled(true)
                .build()
                .thenAccept(model -> {
                    AR3DModel activity = weakActivity.get();
                    if (activity != null) {
